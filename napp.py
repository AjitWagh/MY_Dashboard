...
#app.config['MSSQL_HOST'] = 'sd-fdce-df72.nam.nsroot.net'
#app.config['MSSQL_USER'] = 'rgctisvccapu01'
#app.config['MSSQL_PASSWORD'] = 'global.ip.user.analytics.008'
#app.config['MSSQL_DB'] = 'cd20analytics'
